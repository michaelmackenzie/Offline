#ifndef STMGeom_STMAbsorber_hh
#define STMGeom_STMAbsorber_hh
...
namespace mu2e {
  ...
  public:
    ...
    // Genreflex can't do persistency of vector<STMAbsorber> without a default constructor
    STMAbsorber() {}
  private:
