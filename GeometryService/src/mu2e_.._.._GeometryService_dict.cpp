...
#define R__DICTIONARY_FILENAME GeometryServicedIsrcdImu2e_dOdO_dOdO_GeometryService_dict
...
namespace {
  void TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_GeometryService_dict_Impl() {
...
#line 1 "libmu2e_dOdO_dOdO_GeometryService_dict dictionary forward declarations' payload"
...
#line 1 "libmu2e_dOdO_dOdO_GeometryService_dict dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libmu2e_.._.._GeometryService_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_GeometryService_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_GeometryService_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_GeometryService_dict() {
  TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_GeometryService_dict_Impl();
}
