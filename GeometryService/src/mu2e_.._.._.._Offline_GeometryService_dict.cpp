...
#define R__DICTIONARY_FILENAME GeometryServicedIsrcdImu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict
...
namespace {
  void TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict_Impl() {
    static const char* headers[] = {
0    };
    static const char* includePaths[] = {
"/mu2e/app/users/whyaqm/STM_study/step02/fcl_CRV",
...
#line 1 "libmu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict dictionary forward declarations' payload"
...
#line 1 "libmu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libmu2e_.._.._.._Offline_GeometryService_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict() {
  TriggerDictionaryInitialization_libmu2e_dOdO_dOdO_dOdO_Offline_GeometryService_dict_Impl();
}
